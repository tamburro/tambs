...
export const translations = {
  en: {
    ...
    profile: {
      ...
      bio: "Product Designer with 16 years of experience, 7 in digital product (UX/UI). From discovery and information architecture to HTML/CSS/JS implementation. I build AI-driven products and vibe code from idea to production.",
    ...
    resume: {
      ...
      exp2: 'Worked at EnsineMe (YDUQS group) in multidisciplinary teams building digital educational products. Figma prototyping and development of e-learning lessons in HTML, CSS and JS with high prototype fidelity. Design System application, redesign of educational infographics, and agile demand management (Azure DevOps), collaborating with curation, instructional design and development teams.',
      exp3: 'Design of educational interfaces for Estácio\'s distance learning platform, focused on pedagogical clarity and consistency. Development of e-learning lessons in HTML, CSS and JS with high prototype fidelity, Design System application, and redesign of educational infographics to ease comprehension of complex content.',
      ...
      expUniverso: 'Independent design brand. From illustration and visual identity to prototyping SaaS, apps and end-to-end digital products, integrating UX, front-end and AI-driven design.',
      titleZion: 'Graphic Design Teacher',
      yearZion: 'Dec 2018 – Apr 2019',
      expZion: 'In-person Graphic Design teaching for teenagers and children at the Zion Caxias unit.',
  ...
  pt: {
    ...
    profile: {
      ...
      bio: 'Product Designer com 16 anos de carreira, 7 em produto digital (UX/UI). Da descoberta e arquitetura de informação à implementação em HTML/CSS/JS. Construo produtos orientados por IA com vibe coding, da ideia à produção.',
    ...
    resume: {
      ...
      exp2: 'Atuação na EnsineMe (grupo YDUQS) em times multidisciplinares de produtos educacionais digitais. Prototipação no Figma e desenvolvimento de aulas EAD em HTML, CSS e JS com alta fidelidade ao protótipo. Aplicação de Design System, redesign de infográficos educacionais e gestão de demandas em metodologias ágeis (Azure DevOps), em colaboração com curadoria, design instrucional e desenvolvimento.',
      exp3: 'Design de interfaces educacionais para a plataforma EAD da Estácio, com foco em clareza pedagógica e consistência. Desenvolvimento de aulas EAD em HTML, CSS e JS com alta fidelidade ao protótipo, aplicação de Design System e redesign de infográficos educacionais para facilitar a compreensão de conteúdos complexos.',
      ...
      expUniverso: 'Marca autoral de design. Da ilustração e identidade visual à prototipação de SaaS, apps e produtos digitais de ponta a ponta, integrando UX, front-end e AI-driven design.',
      titleZion: 'Professor de Design Gráfico',
      yearZion: 'Dez 2018 – Abr 2019',
      expZion: 'Ensino presencial de Design Gráfico para adolescentes e crianças na unidade Zion Caxias.',
