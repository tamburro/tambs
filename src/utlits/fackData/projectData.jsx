...
export const projectsData = [
    ...
    },
    {
        ...
        category: "Product Designer · Conversão & Aquisição",
        tags: ["Product Design"],
        ...
        description_en: "A/B test conducted as a team on O Globo's subscription acquisition pages, comparing the existing institutional landing page against a more focused variant inspired by the NYT's editorial hierarchy. The project involved design hypothesis, test structure and results analysis, including the tension between platform metrics and CRM data.",
        year: "2026",
        ...
        sections: [
            {
                ...
                title_en: "The Problem",
                type: "text",
                content: "Produtos de assinatura vivem numa tensão permanente: a landing page precisa converter agora, mas também precisa sustentar o posicionamento de uma marca com décadas de reputação. Mais conteúdo na página pode aumentar a confiança ou aumentar o abandono. Mais foco pode facilitar a decisão ou reduzir o argumento de compra.\n\nA pergunta que guiou o projeto: uma abordagem mais limpa e direta, que chega ao preço mais rápido e remove fricção da jornada, converte melhor que a versão atual com múltiplos argumentos e seções, sem comprometer a performance da campanha principal?",
                content_en: "Subscription products live in a permanent tension: the landing page needs to convert now, but it also needs to sustain the positioning of a brand with decades of reputation. More content on the page can increase trust or increase drop-off. More focus can ease the decision or reduce the sales argument.\n\nThe question that guided the project: would a cleaner, more direct approach, one that reaches the price faster and removes friction from the journey, convert better than the current version with multiple arguments and sections, without compromising the main campaign's performance?",
            },
            {
                title: "Hipótese de Design",
                title_en: "Design Hypothesis",
                type: "research",
                methods: [
                    "Variante A: landing page institucional vigente",
                    "Variante B: abordagem editorial direta, inspirada no NYT",
                    "Fontes de medição: plataforma de anúncios + CRM",
                    "Teste estruturado para proteger a performance da campanha principal",
                ],
                methods_en: [
                    "Variant A: current institutional landing page",
                    "Variant B: direct editorial approach, inspired by the NYT",
                    "Measurement sources: ad platform + CRM",
                    "Test structured to protect the main campaign's performance",
                ],
                content: "A hipótese partia de um benchmark com veículos internacionais de assinatura. O NYT e o The Atlantic convertem com páginas que reduzem o número de decisões intermediárias: menos seções, hierarquia mais clara, preço visível cedo. A página vigente d'O Globo seguia a lógica oposta: construir o argumento em camadas antes de apresentar a oferta. A variante B testou se simplificar essa jornada melhoraria a taxa de conversão.",
                content_en: "The hypothesis came from benchmarking international subscription outlets. The NYT and The Atlantic convert with pages that reduce the number of intermediate decisions: fewer sections, clearer hierarchy, price visible early. O Globo's existing page followed the opposite logic: building the argument in layers before presenting the offer. Variant B tested whether simplifying this journey would improve the conversion rate.",
            },
            {
            ...
            },
            {
                ...
                type: "research",
                methods: [
                    "Hierarquia do fold: credenciais vs. produto editorial em primeiro plano",
                    "Tom de voz: institucional e abrangente vs. direto e jornalístico",
                    "Posicionamento do CTA: acima ou abaixo da proposta de valor",
                    "Prova social: colunistas e parceiros vs. benefícios condensados",
                    "Estrutura da oferta: tabela de três planos vs. seletor focado",
                ],
                methods_en: [
                    "Fold hierarchy: credentials vs. editorial product front and center",
                    "Tone of voice: institutional and broad vs. direct and journalistic",
                    "CTA positioning: above or below the value proposition",
                    "Social proof: columnists and partners vs. condensed benefits",
                    "Offer structure: three-plan table vs. focused selector",
                ],
                content: "A variante B não foi uma reformulação completa. Foi uma reordenação de prioridades. O que muda não é o produto, é a sequência em que o usuário encontra o argumento de compra: primeiro o jornalismo, depois a credencial, depois o preço.",
                content_en: "Variant B wasn't a complete overhaul. It was a reprioritization. What changes isn't the product — it's the sequence in which the user encounters the purchase argument: journalism first, credentials second, price last.",
                highlights: [
                    "Fold: variante B abre com headline de promessa de marca e seletor de plano visível imediatamente",
                    "CTA: mesma oferta, reposicionado para aparecer após a proposta de valor, não antes",
                    "Tom: variante B usa segunda pessoa direta vs. terceira pessoa institucional da variante A",
                    "Prova social: variante A usa colunistas com foto e parceiros do Clube; variante B condensa em lista de benefícios com ícones",
                    "Oferta: variante A exibe tabela completa de três planos; variante B usa seletor focado com uma escolha de cada vez",
                ],
                highlights_en: [
                    "Fold: variant B opens with a brand promise headline and immediately visible plan selector",
                    "CTA: same offer, repositioned to appear after the value proposition, not before",
                    "Tone: variant B uses direct second person vs. the institutional third person of variant A",
                    "Social proof: variant A uses columnists with photos and Club partners; variant B condenses into an icon benefit list",
                    "Offer: variant A shows a full three-plan table; variant B uses a focused selector with one choice at a time",
                ],
            },
            {
                title: "O que os Dados Revelaram",
                title_en: "What the Data Revealed",
                type: "outcomes",
                metrics: [
                    { value: "+5pp", label: "CTR — variante B (índice base: A = 100)" },
                    { value: "+2pp", label: "Tx. Conversão Ads — variante B" },
                    { value: "+11pp", label: "LTV — assinantes captados pela variante B" },
                ],
                metrics_en: [
                    { value: "+5pp", label: "CTR — variant B (base index: A = 100)" },
                    { value: "+2pp", label: "Ads conversion rate — variant B" },
                    { value: "+11pp", label: "LTV — subscribers acquired via variant B" },
                ],
                content: "Os resultados foram analisados pela equipe a partir de duas fontes: dados da plataforma de anúncios e registros de CRM, que nem sempre contavam a mesma história. A variante mais focada converteu melhor por clique e atraiu assinantes com maior valor ao longo do tempo. Mas o custo de aquisição foi consideravelmente mais alto, criando uma decisão não trivial: melhor qualidade de aquisição versus maior custo por assinante.",
                content_en: "Results were analyzed by the team from two sources: ad platform data and CRM records, which didn't always tell the same story. The more focused variant converted better per click and attracted subscribers with higher long-term value. But acquisition cost was considerably higher, creating a non-trivial decision: better acquisition quality versus higher cost per subscriber.",
            },
            {
                title: "Aprendizados",
                title_en: "Learnings",
                type: "research",
                methods: [
                    "Plataforma de anúncios e CRM divergiram: fontes de verdade distintas para a mesma venda",
                    "Qualidade vs. volume: variante B capta melhor, mas custa mais por assinante",
                    "LTV como métrica central: taxa de conversão isolada não conta a história completa",
                    "Resultado inconclusivo para escalar: requer análise de payback period antes de expandir",
                ],
                methods_en: [
                    "Ad platform and CRM diverged: distinct sources of truth for the same sale",
                    "Quality vs. volume: variant B acquires better, but costs more per subscriber",
                    "LTV as the central metric: conversion rate alone doesn't tell the full story",
                    "Inconclusive for scaling: requires payback period analysis before expanding",
                ],
                content: "O aprendizado mais importante não veio da comparação entre A e B. Veio de dentro da análise: as duas fontes de dados utilizadas pela equipe contavam histórias diferentes sobre as mesmas vendas, o que levou à discussão sobre qual fonte de verdade usar para decisões de produto em campanhas futuras.\n\nSobre a hipótese: inconclusiva para escalar, mas com dois aprendizados que mudaram como a equipe analisa campanhas futuras. A abordagem mais focada atrai um perfil de assinante mais comprometido com o produto, o que o LTV superior sugere. Mas o custo de aquisição mais alto exige uma análise de payback period antes de qualquer expansão do teste.",
                content_en: "The most important learning didn't come from comparing A and B. It came from inside the analysis: the two data sources used by the team told different stories about the same sales, which led to a discussion about which source of truth to use for product decisions in future campaigns.\n\nOn the hypothesis: inconclusive for scaling, but with two learnings that changed how the team analyzes future campaigns. The more focused approach attracts a more product-committed subscriber profile, which the higher LTV suggests. But the higher acquisition cost requires payback period analysis before any test expansion.",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        src: "/images/projects/tradeview_full.jpg",
        pageSrc: "/images/projects/tradeview_full.jpg",
    ...
    },
    {
        ...
        src: "/images/projects/market_analytics_full.jpg",
        pageSrc: "/images/projects/market_analytics_full.jpg",
        category: "React · Data Visualization",
        tags: ["React", "Data Viz", "Fintech"],
