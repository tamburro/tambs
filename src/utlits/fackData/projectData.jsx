...
export const projectsData = [
    {
        ...
        src: "/images/projects/ifood_subida/cover.png",
        ...
        sections: [
            ...
            },
            {
                ...
                content: "O iFood domina 92–93% do mercado brasileiro de delivery com 60 milhões de usuários ativos e 440 mil entregadores parceiros. Esse domínio começa a ser pressionado: 99Food voltou com R$ 1 bilhão e zero taxa para restaurantes; Rappi planeja R$ 1,4 bilhão de aporte; Meituan (US$ 600 bilhões de valuation) anunciou R$ 5,6 bilhões para entrar no Brasil. Nesse cenário, diferenciais que fortalecem a relação com entregadores valem mais do que parecem — são ativos estratégicos, não apenas sociais. O benchmark de gorjetas revelou o gap: DoorDash e Uber Eats têm gorjeta pré-checkout visível ao entregador antes do aceite. Nenhuma plataforma, em nenhum país, tem uma feature específica para o esforço de subida.",
                content_en: "iFood holds 92–93% of Brazil's delivery market with 60M active users and 440K delivery partners. This dominance is under growing pressure: 99Food returned with R$1B and zero restaurant fees; Rappi plans a R$1.4B investment; Meituan (US$600B valuation) announced R$5.6B to enter Brazil. In this context, features that strengthen delivery worker relationships are worth far more than they appear — they're strategic assets, not just social ones. The tip benchmark revealed the gap: DoorDash and Uber Eats have pre-checkout tips visible to delivery workers before accepting. No platform, anywhere in the world, has a feature specific to staircase effort.",
                highlights: [
                    "440 mil entregadores — maioria homens negros, periféricos, ~34 anos, com 3 dependentes e jornada de 10–14h/dia",
                    "Renda líquida real de ~R$ 20/hora após combustível, manutenção de veículo e sem benefícios CLT",
                    "A subida não entra no cálculo da rota, não é remunerada e não pode ser recusada sem risco de avaliação negativa",
                    "Projeção: R$ 16,2M/mês de impacto direto a entregadores com apenas 10% de adoção e gorjeta mínima de R$ 3",
                    "Gap identificado: nenhum player entrega gorjeta contextual + visibilidade pré-aceite + categoria nomeada simultaneamente",
                ],
                highlights_en: [
                    ...
                    "Projection: R$16.2M/month direct impact with only 10% adoption and a minimum R$3 tip",
                    "Gap identified: no player simultaneously delivers contextual tip + pre-acceptance visibility + named category",
                ],
            },
            {
                title: "Personas: Dois Lados do Mesmo Problema",
                title_en: "Personas: Two Sides of the Same Problem",
                type: "research",
                methods: ["Cebrap 2024", "UFPR / Clínica de Direito do Trabalho 2025", "Portal de Dados iFood", "Klavi Q1 2025", "Panorama Mobile Time dez/2024"],
                methods_en: ["Cebrap 2024", "UFPR / Labor Law Clinic 2025", "iFood Data Portal", "Klavi Q1 2025", "Mobile Time Panorama Dec/2024"],
                content: "Rodrigo Nascimento, 34 anos, Zona Sul de SP, entregador há 4 anos. Trabalha 10h por dia, de terça a domingo, priorizando Moema e Vila Mariana. Renda bruta de ~R$ 3.200, líquida ~R$ 2.400 após despesas. A cada prédio sem elevador, ele toma uma decisão cega: só descobre o andar ao tocar o interfone. Camila Ferreira, 29 anos, Pinheiros, analista numa fintech. Mora no 11º andar, usa o iFood ~5 vezes por semana, Clube iFood há 2 anos. Nunca parou para pensar na subida — não por indiferença, mas porque o sistema nunca criou esse momento de consciência. A Subida cria.",
                content_en: "Rodrigo Nascimento, 34, South Zone of SP, delivery worker for 4 years. Works 10h/day, Tuesday to Sunday, covering Moema and Vila Mariana. Gross income ~R$3,200, net ~R$2,400 after expenses. At every building without an elevator, he makes a blind decision: only discovers the floor at the intercom. Camila Ferreira, 29, Pinheiros, analyst at a fintech. Lives on the 11th floor, uses iFood ~5x/week, Clube iFood for 2 years. Never thought about the staircase — not from indifference, but because the system never created that moment of awareness. Subida creates it.",
                highlights: [
                    "Rodrigo: 'Quando chega num prédio alto sem elevador, eu já sei que vai custar. Subo, entrego, desço — sem nenhum centavo a mais por isso.'",
                    "Camila: 'Nunca parei pra pensar nisso. Mas subir 11 andares com minha comida toda vez, sem ganhar nada a mais? Eu pagaria sem pensar.'",
                    "Rodrigo aceitaria subidas com mais frequência se soubesse o valor antes — hoje ele tende a perguntar o andar no interfone, gerando atrito",
                    "Para Camila, a barreira é zero: já está no checkout, custa R$ 3, vai direto pro entregador, sem ação após a entrega",
                ],
                highlights_en: [
                    "Rodrigo: 'When I arrive at a building without an elevator, I already know it will cost me. I go up, deliver, come down — without a single extra cent.'",
                    "Camila: 'I never thought about it. But climbing 11 floors with my food every time, getting nothing extra? I'd pay without hesitation.'",
                    "Rodrigo would accept staircase rides more often if he knew the value beforehand — today he tends to ask the floor at the intercom, creating friction",
                    "For Camila, the barrier is zero: it's already in checkout, costs R$3, goes directly to the worker, no post-delivery action needed",
                ],
            },
            {
                ...
                type: "text",
                content: "O mapeamento de ambas as jornadas revelou um padrão: o maior ponto de atrito bilateral acontece no mesmo momento — a chegada ao endereço. Para Camila, a ambiguidade 'vai subir ou não?' gera uma micro-frustração que ela não reconhece como problema, porque o sistema nunca ofereceu alternativa. Para Rodrigo, o aceite da corrida é a decisão mais importante que ele toma sem informação suficiente.\n\nA Subida intervém em dois momentos-chave: no checkout, cria o momento de consciência de Camila e estabelece o combinado explícito; no aceite da corrida, dá a Rodrigo o dado que faltava. O sentimento médio de Camila sobe de 2,7 para 4,7 em 5 ao longo da jornada. O de Rodrigo, de 1,8 para 4,3 — o ponto mais crítico, a etapa de 'Subida / Entrega', passa de sentimento máximo negativo (😤) para positivo (😊).",
                content_en: "Mapping both journeys revealed a pattern: the highest bilateral friction point happens at the same moment — arrival at the address. For Camila, the 'will they come up or not?' ambiguity creates a recurring micro-frustration she doesn't recognize as a problem, because the system never offered an alternative. For Rodrigo, accepting the ride is the most important decision he makes without enough information.\n\nSubida intervenes at two key moments: in checkout, creating Camila's moment of awareness and establishing an explicit agreement; at ride acceptance, giving Rodrigo the missing data. Camila's average sentiment rises from 2.7 to 4.7 out of 5 across the journey. Rodrigo's goes from 1.8 to 4.3 — the most critical point, the 'Staircase / Delivery' stage, shifts from maximum negative (😤) to positive (😊).",
            },
            {
                ...
                content: "Cada decisão foi tomada com análise de trade-off explícita e alternativas documentadas. O projeto rejeitou cinco abordagens antes de chegar ao modelo atual — cada rejeição revela uma premissa sobre como a feature precisa funcionar para ter valor real.",
                content_en: "Every decision was made with explicit trade-off analysis and documented alternatives. The project rejected five approaches before reaching the current model — each rejection reveals a premise about how the feature needs to work to have real value.",
                highlights: [
                    ...
                    "Por que stepper e não chips (R$3 / R$5 / R$10)? Chips criam âncora social que pode gerar pressão; o stepper é neutro, fluido e usa padrão que o iFood já tem",
                    ...
                    "Por que opt-in e não obrigatório? Obrigatório destrói o posicionamento de gesto voluntário, que é o núcleo da proposta de valor da feature",
                ],
                highlights_en: [
                    ...
                    "Why stepper over chips (R$3 / R$5 / R$10)? Chips create social anchoring that can feel like pressure; stepper is neutral, fluid, and uses a pattern iFood already has",
            ...
            {
                title: "Fluxo de Telas & Protótipo Interativo",
                title_en: "Screen Flow & Interactive Prototype",
                type: "text",
                content: "O fluxo documenta 9 estados de interface — 5 na jornada da usuária (checkout sem Subida, bloco Subida inativo, bloco ativo com stepper, notificação de aceite pelo entregador, notificação de transferência automática) e 4 na jornada do entregador (card sem Subida como referência, card com badge e valor de Subida, tela de detalhe pós-aceite, notificação de crédito).\n\nTodas as telas seguem convenções que o iFood já usa: stepper de quantidade, notificações push, fluxo de contestação de reembolso. A única convenção nova é o badge de Subida no card da corrida — desenhado para ser detectável em aceites rápidos, com valor exato em zona de alta atenção e hierarquia visual clara. O protótipo interativo permite navegar os dois fluxos completos — explore pelo link 'Live Demo' acima.",
                content_en: "The flow documents 9 interface states — 5 on the user journey (checkout without Subida, inactive Subida block, active block with stepper, delivery worker acceptance notification, automatic transfer notification) and 4 on the delivery worker journey (card without Subida as reference, card with Subida badge and value, post-acceptance detail screen, credit notification).\n\nAll screens follow conventions iFood already uses: quantity stepper, push notifications, refund contestation flow. The only new convention is the Subida badge on the ride card — designed to be detectable in quick accepts, with exact value in a high-attention zone and clear visual hierarchy. The interactive prototype lets you navigate both complete flows — explore via the 'Live Demo' link above.",
            },
            {
                ...
                highlights: [
                    "Visibilidade sem culpa: a ativação não pode fazer o usuário se sentir cobrado. É uma oferta, não uma taxa — o tom visual e textual deve ser neutro-positivo",
                    "Agência real para o entregador: a feature só tem valor se ele tiver informação suficiente para decidir antes de aceitar. Mostrar o valor no aceite não é detalhe — é o produto",
                    "Transferência automática como padrão: o dinheiro do trabalhador não pode depender de ação de terceiro. O padrão é pagar; a exceção é contestar",
                    "Consistência: stepper, notificações, fluxo de contestação. Nenhuma nova convenção de interação foi introduzida — zero curva de aprendizado",
                    "Transparência: 'Esse valor vai integralmente para o entregador' — não como disclaimer jurídico, mas como parte central da proposta de valor",
                ],
                highlights_en: [
                    "Visibility without guilt: activation cannot make the user feel charged. It's an offer, not a fee — tone must be neutral-positive",
                    "Real agency for the delivery worker: the feature only has value if they have enough information to decide before accepting. Showing the value at acceptance isn't a detail — it is the product",
                    "Automatic transfer as default: worker payment can't depend on a third party's action. The default is to pay; contestation is the exception",
                    "Consistency: stepper, notifications, contestation flow. No new interaction convention was introduced — zero learning curve",
                    "Transparency: 'This value goes entirely to the delivery worker' — not as a legal disclaimer, but as the central value proposition",
                ],
            },
            {
                ...
                content: "A projeção parte de 180M pedidos/mês e assume que 30% são entregues em apartamentos (estimativa conservadora para contexto urbano): 54M pedidos elegíveis. Com 10% de adoção e gorjeta mínima de R$ 3 → R$ 16,2M adicionais por mês, direto para entregadores. Esses valores não são receita do iFood — são repasse ao trabalhador, e essa narrativa de impacto social é exatamente o que concorrentes com 'zero taxa' não conseguem replicar.\n\nO custo de desenvolvimento é baixo: a Subida usa fluxos e componentes que o iFood já tem. A barreira de entrada é zero para o usuário. O diferencial competitivo é alto e defensável. A feature cria uma categoria nova — não é gorjeta genérica, é reconhecimento contextual de um trabalho específico.",
                content_en: "The projection starts from 180M orders/month and assumes 30% are delivered to apartments (conservative estimate for urban context): 54M eligible orders. With 10% adoption and minimum R$3 tip → R$16.2M additional per month, direct to delivery workers. These values aren't iFood revenue — they're direct transfers to workers, and that social impact narrative is exactly what 'zero fee' competitors can't replicate.\n\nDevelopment cost is low: Subida uses flows and components iFood already has. Entry barrier is zero for the user. Competitive differentiation is high and defensible. The feature creates a new category — not a generic tip, but contextual recognition of a specific kind of work.",
            },
        ],
    },
    {
        ...
        timeline: "2 dias (1º deploy)",
        timeline_en: "2 days (1st deploy)",
        team: "Solo",
    ...
    },
    {
        ...
        timeline: "1 dia (1º deploy)",
        timeline_en: "1 day (1st deploy)",
        team: "Solo",
        client: "Produto próprio",
